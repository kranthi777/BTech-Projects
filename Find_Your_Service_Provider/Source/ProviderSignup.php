...
if (empty($_POST["Provider_Type"])) {
     $pwdErr = "must select the service offered";
   } 
else
{
...
$check= "SELECT *FROM ServiceProviderDatabase WHERE UserName = '$name' ";
...
if(isset($name,$pwd,$email,$mobile,$Provider_Type))
{
//create custom page........
$arr = array('Provider_custompage/',$name,'.php');
...
$sql = "INSERT INTO ServiceProviderDatabase (UserName,PassWord,Mobile,email,PicAddress,CustomPageLink,ServiceType)
VALUES ('$name','$pwd','$mobile','$email','Provider_images/default.jpg','$custom','$Provider_Type')"; /////////////////////////////////////////////////aabhi baki hai...................
if (mysqli_query($conn, $sql)) {
} else {
    echo "Error: " . $sql . "<br>" . mysqli_error($conn);
}
//////////////////////now i will insert username in the customer location table.....
$checking= "INSERT INTO Provider_Location (User_Name) VALUES ('$name')";
if (mysqli_query($conn, $checking)) {
} else {
    echo "Error: " . $checking . "<br>" . mysqli_error($conn);
}
//now take him to homepage.....
$_SESSION["ProviderUsername"] = $name;
$_SESSION["access"] = "yes";
...
echo "<script> window.location.assign('Provider_home.php'); </script>";  
}
}
?>
...
<style>
body {
    background-image: url("http://wallpaper.pickywallpapers.com/1920x1080/indoor-logs.jpg");
}
#one
{
margin-left:32%;
...
{
var u = document.forms["SignUpForm"]["Provider_Type"].value;
...
if (u == null) {
        alert("Service Offered must be selected");
        return false;
    }
...
<span class="error">* <?php echo $mobileErr;?></span>
   <br><br>
Service Offered:<br>
<input type="radio" name="Provider_Type" value="Electrician">Electrician<br>
<input type="radio" name="Provider_Type" value="Caterer">Caterer<br>
<input type="radio" name="Provider_Type" value="Plumber">Plumber<br>
<input type="radio" name="Provider_Type" value="Fabrication_Works">Fabrication_Works<br>
<input type="radio" name="Provider_Type" value="Flooring_repairs">Flooring_Repairs<br>
<input type="radio" name="Provider_Type" value="Fan_repair">Fan_Repairs<br>
<input type="radio" name="Provider_Type" value="Decoration">Decoration<br>
<input type="radio" name="Provider_Type" value="Glass_works">Glass_Works<br>
<input type="radio" name="Provider_Type" value="WashingMachines_repair">WashingMachines_Repairs<br>
<input type="radio" name="Provider_Type" value="Gas_stove_repair">GasStove_Repairs<br>
